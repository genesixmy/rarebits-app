  ...
  constructor(endPoint, options) {
    ...
    this._resolveFetch = (customFetch) => {
      ...
      if (customFetch) {
        ...
        _fetch = (...args) => import("./browser-AZDWR4MG.js").then(({ default: fetch2 }) => fetch2(...args)).catch((error) => {
...
var resolveFetch5 = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = async (...args) => await (await import("./browser-ponyfill-VMJ26AX4.js")).fetch(...args);
  } else {
    _fetch = fetch;
  }
  return (...args) => _fetch(...args);
