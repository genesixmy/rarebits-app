-- SHIP-4.1: Allow courier payment recording before tracking/delivered.
-- Rule: courier payment can be recorded when shipment is pending/shipped/delivered.
-- No tracking_no requirement.
