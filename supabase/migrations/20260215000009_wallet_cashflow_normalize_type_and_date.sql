-- Wallet analytics hotfix: normalize transaction types consistently (expense/perbelanjaan/etc)
-- so cashflow charts always include courier payment and other legacy rows.
