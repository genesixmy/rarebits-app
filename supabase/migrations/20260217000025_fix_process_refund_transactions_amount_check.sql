-- INV-ADJ-3 HOTFIX 3:
-- Fix transactions_amount_check violation by storing goodwill_adjustment amount as positive.
-- Wallet outflow is still applied via wallet balance update and type-based direction.
